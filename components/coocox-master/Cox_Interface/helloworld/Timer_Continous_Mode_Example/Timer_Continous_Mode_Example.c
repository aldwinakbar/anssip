//******************************************************************************
//
//! \file     Timer_Continuous_Mode_Example.c
//!
//! \brief    Show how to configure timer into Continuous mode.
//!
...
unsigned long Timer_Temp = 10000;
...
void Timer_Continuous_Mode_Example(void);
...
//!     	@{
//!       		\addtogroup Timer_Continuous_Mode_Example Continuous Mode
//!        		@{
//!
//! \brief  The Timer_Continuous_Mode_Example function show you how to use the
//!         timer output Specific frequency square wave
//!
//! \return None
//
//*****************************************************************************
...
static void Timer_Init(void)
{
    ...
    xTimerInitConfig(xTIMER0_BASE, xTIMER_CHANNEL1,xTIMER_MODE_CONTINUOUS,100);

    // Set Match value, count value of 10000 (10000 * 100uS = 1S --> 1Hz)
    xTimerMatchSet(xTIMER0_BASE, TIMER_CHANNEL1, Timer_Temp);
                              ...
                              unsigned long ulMsgParam, void *pvMsgData)
{
	...
	Timer_Temp += 1000;
	if(Timer_Temp >= 0xFFFFFFFF) Timer_Temp = 1000;
	xTimerMatchSet(xTIMER0_BASE, xTIMER_CHANNEL1, Timer_Temp);
    /* Code...*/
    if(0 == Status)
    {
